            ...
            <div class="col-lg-5 col-md-6">
                @if (isset($psychologist->title))
                    <div class="content pl-lg-3 pl-0">
                        <h2 id="helllo-im-richi-andorn-im-a-biography-based-researcher-and-author">{!! $psychologist->title !!}
                        </h2>
                    </div>
                @endif
            </div>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
                        <div class="video-wrapper">
                            <img src="{{ 'https://img.youtube.com/vi/' . explode('?', explode('/', $psychologist->video_url)[3])[0] . '/maxresdefault.jpg' }}"
                                class="img-fluid">
                            <a class="play-btn video-btn" data-toggle="modal"
                                data-src="{{ 'https://youtube.com/embed/' . explode('/', $psychologist->video_url)[3] }}"
                                data-target="#myModal" href="{{ $psychologist->youtube_url }}"><i
                    ...
                    <div class="modal-body">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item"
                                src="{{ 'https://youtube.com/embed/' . explode('/', $psychologist->video_url)[3] }}"
                ...
                <div class="col-lg-10 mx-auto text-center">
                    ...
                    <ul class="list-inline logo-list">
                        ...
                        @if (isset($psychologist->instagram))
                            <li class="list-inline-item">
                                <a href="{{ $psychologist->instagram }}" target="_blank">
                                    <img class="img-fluid" src="theme/theme/images/logos/insta-logo.png"
                                        alt="Instagram Logo">
                                </a>
                            </li>
                        @endif
                        @if (isset($psychologist->telegram))
                            <li class="list-inline-item">
                                <a href="https://t.me/{{ $psychologist->telegram }}" target="_blank"><img class="img-fluid"
                                        src="theme/theme/images/logos/telegram-logo.png" alt="Telegram Logo">
                                </a>
                            </li>
                        @endif
