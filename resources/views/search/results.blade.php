        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-10">
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-md-4 mb-4 mb-md-0">
                            <div class="post-slider slider-sm">
                                <img src="{{ asset($activity->image[0]) }}" class="card-img" alt="post-thumb" style="height:200px; object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-md-8">
                            @else
                            <div class="col-md-12">
                                @endif
                                <h3 class="h4 mb-3"><a class="post-title" href="/activity/{{ $activity->id }}">{{ $activity->title }}</a></h3>
                                <ul class="card-meta list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <ul class="card-meta-tag list-inline">
                                            <li class="list-inline-item"><a href="/category/{{ $activity->category->id }}">{{ $activity->category->title }}</a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <article class="card mb-4">
                    <div class="row card-body">
                        <div class="col-md-12">
                            <h3 class="h4 mb-3"><a class="post-title" href="/event/{{ $event->id }}">{{ $event->title }}</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="/about" class="card-meta-author">
                                        <span>Світлана Савіцька</span>
                            ...
                            <a href="/event/{{ $event->id }}" class="btn btn-outline-primary">Переглянути деталі</a>
                        </div>
                    </div>
                </article>
                @endforeach
                ...
                <article class="card mb-4">
                    <div class="row card-body">
                        ...
                        <div class="col-md-4 mb-4 mb-md-0">
                            <div class="post-slider slider-sm">
                                <img src="{{ asset($category->image[0]) }}" class="card-img" alt="post-thumb" style="height:200px; object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-md-8">
                            @else
                            <div class="col-md-12">
                                @endif
                                <h3 class="h4 mb-3"><a class="post-title" href="/category/{{ $category->id }}">{{ $category->title }}</a></h3>
                                <p>{!! Str::limit(strip_tags($category->description), 250) !!}</p>
                                <a href="/category/{{ $category->id }}" class="btn btn-outline-primary">Переглянути деталі</a>
                            </div>
                        </div>
                </article>
                @endforeach
