    ...
    <div class="row">
        <aside class="col-lg-4">
            ...
            <ul class="nav nav-tabs nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link active btn btn-outline-primary mb-2 btn-block" href="#" data-target="#profile-settings">Налаштування профілю</a>
                </li>
            </ul>
            <div class="widget">
                ...
                <article class="widget-card">
                    <div class="d-flex">
                        <div class="ml-3">
                            <h5><a class="post-title" href="/event/{{ $booking->event->id }}">{{ $booking->event->name }}</a></h5>
            ...
            <ul class="nav nav-tabs nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link btn mb-2  btn btn-outline-primary btn-block" href="#" data-target="#all-bookings">Бронювання</a>
                </li>
            </ul>
            <div class="widget">
                ...
                <article class="widget-card">
                    <div class="d-flex" style="min-width: 250px; word-wrap: break-word; overflow-wrap: break-word;">
                        <div class="ml-3">
                            <h5><a class="post-title" href="/event/{{ $comment->event->id }}">{{ $comment->event->name }}</a></h5>
            ...
            <ul class="nav nav-tabs nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link btn mb-2  btn btn-outline-primary btn-block" href="#" data-target="#all-comments">Коментарі</a>
                </li>
            </ul>
        </aside>
        <!-- Main Content Area -->
        <div class="col-lg-8 mb-5 mb-lg-3">
            ...
            <div class="tab-content">
                    ...
                    <article class="mb-4">
                        <div class="row card">
                            <div class="col-md-12 card-body">
                                ...
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <ul class="card-meta-tag list-inline">
                                            <li class="list-inline-item">
                                                <a class="payment-status" style="color: {{ $booking->payment_status ? '#28a745' : '#dc3545' }};">
                                ...
                                @else
                                <a href="#" class="btn btn-outline-primary reject-booking" data-booking-id="{{ $booking->id }}">Відхилити бронювання</a>
                                @endif
                            </div>
                        </div>
                    </article>
                ...
                <div class="tab-pane fade" id="all-comments">
                    ...
                    <div class="w-100 py-2 px-2" style="background-color: #f1f1f1; border-bottom: 1px solid #ccc;">
                        <a class="d-inline-block mr-2" style="text-decoration: none;" href="#">
                            <div class="user-icon rounded-circle" style="min-width:30px; min-height:30px; background-color: {{'hsl(' . hexdec(substr(md5($comment->username), 0, 2)) . ', 60%, 50%)'}};">
                                <center>
                                    <span class="initial" style="line-height:30px;color: white; text-transform: uppercase;">
                                        {{ mb_substr($comment->username, 0, 1) }}
                                    </span>
                                </center>
                            </div>
                        </a>
                        <span><strong>{{ $comment->username }}</strong> коментар під записом <a href="/event/{{ $comment->event->id }}" class="alert-link">"{{ $comment->event->name }}"</a></span>
                    </div>
